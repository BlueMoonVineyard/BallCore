...
import BallCore.CustomItems.{CustomItemStack, ItemGroup, ItemRegistry, PlainCustomItem}
...
object Gear:
  ...
  def pickaxe[E <: CustomModelDatas](
                                      base: ToolSet[E],
                                      ore: ItemStack,
                                      name: String,
                                      id: String,
    ...
    val recipe =
      ShapedRecipe(NamespacedKey("bc", s"${id.toLowerCase()}_pickaxe"), is)
    recipe.shape(
      "III",
      " S ",
      " S "
  ...
  def chestplate[E <: CustomModelDatas](
                                         base: ToolSet[E],
                                         ore: ItemStack,
                                         name: String,
                                         id: String,
    ...
    val recipe =
      ShapedRecipe(NamespacedKey("bc", s"${id.toLowerCase()}_chestplate"), is)
    recipe.shape(
      "I I",
      "III",
      "III"
  ...
  def leggings[E <: CustomModelDatas](
                                       base: ToolSet[E],
                                       ore: ItemStack,
                                       name: String,
                                       id: String,
    ...
    val recipe =
      ShapedRecipe(NamespacedKey("bc", s"${id.toLowerCase()}_leggings"), is)
    recipe.shape(
      "III",
      "I I",
      "I I"
