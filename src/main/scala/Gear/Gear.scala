...
enum ToolSet[E <: CustomModelDatas](
    ...
    case Iron extends ToolSet[IronToolSetCustomModelDatas](Material.IRON_PICKAXE, Material.IRON_AXE, Material.IRON_SHOVEL, Material.IRON_HOE, Material.IRON_SWORD, Material.IRON_HELMET, Material.IRON_CHESTPLATE, Material.IRON_LEGGINGS, Material.IRON_BOOTS)
    case Gold extends ToolSet[GoldToolSetCustomModelDatas](Material.GOLDEN_PICKAXE, Material.GOLDEN_AXE, Material.GOLDEN_SHOVEL, Material.GOLDEN_HOE, Material.GOLDEN_SWORD, Material.GOLDEN_HELMET, Material.GOLDEN_CHESTPLATE, Material.GOLDEN_LEGGINGS, Material.GOLDEN_BOOTS)
    case Diamond extends ToolSet[DiamondToolSetCustomModelDatas](Material.DIAMOND_PICKAXE, Material.DIAMOND_AXE, Material.DIAMOND_SHOVEL, Material.DIAMOND_HOE, Material.DIAMOND_SWORD, Material.DIAMOND_HELMET, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_LEGGINGS, Material.DIAMOND_BOOTS)
...
object Gear:
    ...
    def pickaxe[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
    ...
    def axe[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('S', Material.STICK)
        registry.addRecipe(recipe)
    def shovel[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('S', Material.STICK)
        registry.addRecipe(recipe)
    def hoe[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('S', Material.STICK)
        registry.addRecipe(recipe)
    def tools[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
    ...
    def sword[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('S', Material.STICK)
        registry.addRecipe(recipe)
    def helmet[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('I', ExactChoice(ore))
        registry.addRecipe(recipe)
    def chestplate[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('I', ExactChoice(ore))
        registry.addRecipe(recipe)
    def leggings[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('I', ExactChoice(ore))
        registry.addRecipe(recipe)
    def boots[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
        ...
        recipe.setIngredient('I', ExactChoice(ore))
        registry.addRecipe(recipe)
    def armor[E <: CustomModelDatas](base: ToolSet[E], ore: ItemStack, name: String, id: String, cmd: E, enchants: (Enchantment, Int)*)(using registry: ItemRegistry): Unit =
