...
object Furnace:
  ...
  val ironFurnace = CustomItemStack.make(
    NamespacedKey("ballcore", "iron_furnace"),
    Material.FURNACE,
    txt"Iron Furnace",
    tierOneLore
  )
  val tinFurnace = CustomItemStack.make(
    NamespacedKey("ballcore", "tin_furnace"),
    Material.FURNACE,
    txt"Tin Furnace",
    tierOneLore
  )
  val aluminumFurnace = CustomItemStack.make(
    NamespacedKey("ballcore", "aluminum_furnace"),
    Material.FURNACE,
    txt"Aluminum Furnace",
    tierOneLore
  )
  val zincFurnace = CustomItemStack.make(
  ...
  val entschloseniteFurnace = CustomItemStack.make(
  ...
  val praecantatioFurnace = CustomItemStack.make(
    NamespacedKey("ballcore", "praecantatio_furnace"),
    Material.BLAST_FURNACE,
    txt"Praecantatio Furnace",
    tierThreeLore
  )
  val auramFurnace = CustomItemStack.make(
    NamespacedKey("ballcore", "auram_furnace"),
    Material.BLAST_FURNACE,
    txt"Auram Furnace",
    tierThreeLore
  )
  val alkimiaFurnace = CustomItemStack.make(
