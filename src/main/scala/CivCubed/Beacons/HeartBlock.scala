...
import CivCubed.Groups.{GroupManager, Permissions, nullUUID}
...
import CivCubed.NoodleEditor.Essence
import CivCubed.Advancements.PlaceCivHeart
import org.bukkit.plugin.Plugin

object HeartBlock:
    val itemStack: CustomItemStack = CustomItemStack.make(
        NamespacedKey("civcubed", "civilization_heart"),
