...
package CivCubed.Plants

import CivCubed.Acclimation.Information
import CivCubed.CustomItems.{CustomItem, CustomItemStack, ItemGroup}
import CivCubed.Datekeeping.Season
...
enum PlantType:
    ...
    def hours(): Int =
        this match
            ...
            case stemmedAgeable(stem, fruit, hoursBetweenStages) =>
                hoursBetweenStages
...
enum Plant(
    ...
    case Birch
        extends Plant(
            PlantType
                .generateTree(Material.BIRCH_SAPLING, TreeType.BIRCH, 24 * 7),
    ...
    case PumpkinStem
        extends Plant(
            PlantType
                .stemmedAgeable(Material.PUMPKIN_STEM, Material.PUMPKIN, 6),
