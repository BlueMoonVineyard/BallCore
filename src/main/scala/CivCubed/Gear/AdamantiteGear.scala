...
private val group =
    ItemGroup(
        NamespacedKey("civcubed", "adamantite_gear"),
...
object AdamantiteGear:
    ...
    private def pickaxe()(using ir: ItemRegistry, p: Plugin): Unit =
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"adamantite_corebreaker"),
            ToolSet.Iron.pick,
    ...
    private def axe()(using ir: ItemRegistry, p: Plugin): Unit =
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"adamantite_woodeater"),
            ToolSet.Iron.axe,
            txt"Adamantite Woodeater",
        )
        register(is, IronToolSetCustomModelDatas.adamantite, enchants)
        val recipe =
            ShapedRecipe(NamespacedKey("civcubed", s"adamantite_woodeater"), is)
        recipe.shape(
            "II",
            "IS",
            " S",
    ...
    private def shovel()(using ir: ItemRegistry, p: Plugin): Unit =
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"adamantite_earthmover"),
            ToolSet.Iron.shovel,
