...
enum IronToolSetCustomModelDatas(val num: Int) extends CustomModelDatas:
    ...
    case adamantite extends IronToolSetCustomModelDatas(13)
...
object Gear:
    ...
    private def pickaxe[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_pickaxe"),
            base.pick,
            txt"$name Pickaxe",
        )
    ...
    private def axe[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_axe"),
            base.axe,
            txt"$name Axe",
        )
        register(is, cmd, enchants)
    ...
    private def shovel[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_shovel"),
            base.shovel,
            txt"$name Shovel",
        )
        register(is, cmd, enchants)
    ...
    private def hoe[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_hoe"),
            base.hoe,
            txt"$name Hoe",
        )
        register(is, cmd, enchants)
    ...
    def sword[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_sword"),
            base.sword,
            txt"$name Sword",
        )
        register(is, cmd, enchants)
    ...
    private def helmet[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_helmet"),
            base.helmet,
            txt"$name Helmet",
        )
        register(is, cmd, enchants)
    ...
    private def chestplate[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_chestplate"),
            base.chestplate,
            txt"$name Chestplate",
        )
        register(is, cmd, enchants)
    ...
    private def leggings[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_leggings"),
            base.leggings,
            txt"$name Leggings",
        )
        register(is, cmd, enchants)
    ...
    private def boots[E <: CustomModelDatas](
        ...
        val is = CustomItemStack.make(
            NamespacedKey("civcubed", s"${id}_boots"),
            base.boots,
            txt"$name Boots",
        )
        register(is, cmd, enchants)
