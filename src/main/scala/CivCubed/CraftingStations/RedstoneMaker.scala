...
object RedstoneMaker {
    val recipes: List[Recipe] = List(
        Recipe(
            ...
            NamespacedKey("civcubed", "make_observer"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_redstone_repeater"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_redstone_comparator"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_piston"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_sticky_piston"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_dispenser"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_dropper"),
            List(
                (Vanilla(Material.COBBLESTONE), 28),
                (Vanilla(Material.REDSTONE), 4),
            ),
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_hopper"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_redstone_lamp"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_elevators"),
            List(
        ...
        Recipe(
            ...
            NamespacedKey("civcubed", "make_redstone_torches"),
            List(
    ...
    val template: CustomItemStack = CustomItemStack.make(
        NamespacedKey("civcubed", "redstone_maker"),
        Material.PISTON,
