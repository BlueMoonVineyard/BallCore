...
import CivCubed.Plants.PlantListProgram
...
import CivCubed.Advancements.ViewPlants
import CivCubed.Plants.Climate

class PlantsCommand(using prompts: CivCubed.UI.Prompts, plugin: Plugin):
    val node =
        CommandTree("plants")
