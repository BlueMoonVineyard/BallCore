...
import CivCubed.UI.{PaneAccumulator, UIProgram, UIServices}
...
import CivCubed.UI.ItemAccumulator
...
import CivCubed.PrimeTime.PrimeTimeError
import java.time.LocalTime
import org.bukkit.OfflinePlayer
import cats.effect.IO
import CivCubed.NoodleEditor.NoodleEditor
import CivCubed.NoodleEditor.NoodleKey
import CivCubed.Advancements.BindCivHeart
import org.bukkit.plugin.Plugin

extension (p: CivCubed.Groups.Permissions)
...
class GroupManagementProgram(using
    ...
    override def init(flags: Flags): Model =
        import CivCubed.PrimeTime.TimeZoneCodec.{encoder, decoder}
