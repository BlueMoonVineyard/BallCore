    ...
    def adjustBlock(block: Block): Block =
        block.getType match
            ...
            case DANDELION | POPPY | BLUE_ORCHID | ALLIUM | AZURE_BLUET |
                ...
                OXEYE_DAISY | ACACIA_SAPLING | BIRCH_SAPLING |
                DARK_OAK_SAPLING | JUNGLE_SAPLING | OAK_SAPLING |
                SPRUCE_SAPLING | WARPED_FUNGUS | CRIMSON_FUNGUS |
                ...
                CRIMSON_ROOTS | NETHER_SPROUTS | WITHER_ROSE |
                LILY_OF_THE_VALLEY | CORNFLOWER | SEA_PICKLE | FERN | KELP |
                SHORT_GRASS | SEAGRASS | TUBE_CORAL | TUBE_CORAL_FAN | BRAIN_CORAL |
                BRAIN_CORAL_FAN | BUBBLE_CORAL | BUBBLE_CORAL_FAN | FIRE_CORAL |
                FIRE_CORAL_FAN | HORN_CORAL | HORN_CORAL_FAN | DEAD_TUBE_CORAL |
                DEAD_TUBE_CORAL_FAN | DEAD_BRAIN_CORAL | DEAD_BRAIN_CORAL_FAN |
                DEAD_BUBBLE_CORAL | DEAD_BUBBLE_CORAL_FAN | DEAD_FIRE_CORAL |
                DEAD_FIRE_CORAL_FAN | DEAD_HORN_CORAL | DEAD_HORN_CORAL_FAN |
                SMALL_DRIPLEAF | NETHER_WART =>
            ...
            case ACACIA_DOOR | BIRCH_DOOR | DARK_OAK_DOOR | IRON_DOOR |
                SPRUCE_DOOR | JUNGLE_DOOR | WARPED_DOOR | CRIMSON_DOOR |
                OAK_DOOR =>
            ...
            case BLACK_BED | BLUE_BED | BROWN_BED | CYAN_BED | GRAY_BED |
                GREEN_BED | MAGENTA_BED | LIME_BED | ORANGE_BED | PURPLE_BED |
                PINK_BED | WHITE_BED | LIGHT_GRAY_BED | LIGHT_BLUE_BED |
                RED_BED | YELLOW_BED =>
            ...
            case TUBE_CORAL_WALL_FAN | BRAIN_CORAL_WALL_FAN |
                BUBBLE_CORAL_WALL_FAN | FIRE_CORAL_WALL_FAN |
                HORN_CORAL_WALL_FAN | DEAD_TUBE_CORAL_WALL_FAN |
            ...
            // so do these
            case SMALL_AMETHYST_BUD | MEDIUM_AMETHYST_BUD |
                LARGE_AMETHYST_BUD =>
            ...
            case POINTED_DRIPSTONE =>
                val dripstone =
                    block.getBlockData.asInstanceOf[PointedDripstone]
                var direction =
                    block.getRelative(
